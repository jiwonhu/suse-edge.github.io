...
* A host for the centralized management cluster (the one hosting Rancher, Elemental and Edge Image Builder):
...
cp /path/to/downloads/SLE-Micro.x86_64-5.5.0-Default-SelfInstall-GM2.install.iso $ELEM/eib_quickstart/base-images/
